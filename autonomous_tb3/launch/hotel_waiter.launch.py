...
def generate_launch_description():
    ...
    table_spawner_1 =Node(
            ...
            executable="sdf_spawner",
            name="hotel_spawner",
            arguments=[table_path,'table_1','-0.72','3.52']    
    )
    ...
    table_spawner_2 =Node(
            ...
            executable="sdf_spawner",
            name="hotel_spawner",
            arguments=[table_path,'table_2','3.12','3.62']       
    )        
    ...
    table_spawner_3 =Node(
            ...
            executable="sdf_spawner",
            name="hotel_spawner",
            arguments=[table_path,'table_3','3.33','-1.89']       
    )
    ...
    table_spawner_4 =Node(
            ...
            executable="sdf_spawner",
            name="hotel_spawner",
            arguments=[table_path,'table_4','-0.85','-2.29']       
    )
