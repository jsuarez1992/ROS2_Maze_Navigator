...
def generate_launch_description():
    ...
    return LaunchDescription([
        #Code from https://github.com/ros-navigation/navigation2/blob/humble/nav2_bringup/launch/bringup_launch.py
       ...
       #Integrating nav2 stack
        IncludeLaunchDescription(PythonLaunchDescriptionSource([get_package_share_directory('nav2_bringup'),'/launch','/bringup_launch.py']),
                                 launch_arguments={
                                     'map': map_file,
